...
public class VSMainWindow extends Screen {
    ...
    private void initBottomSection() {
        ...
        // FIX: Для вкладки Blocks - кнопки управляют эффектами
        if (isBlocksTabActive) {
            // Кнопка Clear - очищает все эффекты
            ...
            // Кнопка Stop - останавливает эффекты

...
public class VSMainWindow extends Screen {
    ...
    protected void init() {
        ...
        // Sidebar buttons
        this.addButton(new Button(panelX + 5, panelY + 25, SIDEBAR_WIDTH - 10, 20, 
            new StringTextComponent("Macros#1"), btn -> tabManager.switchTab("macros1")));
        this.addButton(new Button(panelX + 5, panelY + 50, SIDEBAR_WIDTH - 10, 20, 
            new StringTextComponent("Macros#2"), btn -> tabManager.switchTab("macros2")));
        this.addButton(new Button(panelX + 5, panelY + 75, SIDEBAR_WIDTH - 10, 20, 
            new StringTextComponent("Macros#3"), btn -> tabManager.switchTab("macros3")));
        this.addButton(new Button(panelX + 5, panelY + 100, SIDEBAR_WIDTH - 10, 20, 
            new StringTextComponent("Macros#4"), btn -> tabManager.switchTab("macros4")));
        this.addButton(new Button(panelX + 5, panelY + 125, SIDEBAR_WIDTH - 10, 20, 
